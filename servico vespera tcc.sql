...
--
-- Host: 127.0.0.1
-- Generation Time: 07-Dez-2016 às 08:08
...
(1, '123.456.785-16', 'funcionario1', 'func@func.com', '(123) 1233-1231', '202cb962ac59075b964b07152d234b70', 388883, 20),
(2, '', '', '', '0', 'd41d8cd98f00b204e9800998ecf8427e', 0, 0),
(3, '123.456.798-45', 'funcionario2', 'email@email', '(047) 3442-1282', '202cb962ac59075b964b07152d234b70', 388882, 20),
...
CREATE TABLE `niveis` (
  ...
  `modificarServico` tinyint(1) NOT NULL,
...
INSERT INTO `niveis` (`id_niveis`, `fk_funcionario`, `criarServico`, `verSetores`, `modificarServico`, `admin`, `ceo`) VALUES
(1, 3, 1, 1, 1, 1, 0);
...
(14, 'ixi <span class="label label-default">Criado com sucesso!</span>', '2016-12-06 23:39:36', 1, 19, 30),
(15, 'ixi <span class="label label-default">Criado com sucesso!</span>', '2016-12-06 23:39:45', 1, 20, 31),
(16, 'novo serviÃ§o aqui <span class="label label-default">Criado com sucesso!</span>', '2016-12-07 04:14:42', 3, 21, 32);
